...
void init() {
    ...
    DB_EXEC("CREATE TABLE IF NOT EXISTS parties ("
            ...
            ")");
    DB_EXEC("CREATE TABLE IF NOT EXISTS product_categories ("
            " id     INTEGER NOT NULL DEFAULT 0,"
            " name   TEXT NOT NULL DEFAULT '',"
            " PRIMARY KEY(id AUTOINCREMENT)"
            ")");
    DB_EXEC("CREATE TABLE IF NOT EXISTS products ("
            ...
            " PRIMARY KEY(id AUTOINCREMENT)"
            ")");
    DB_EXEC("CREATE TABLE IF NOT EXISTS stock_updates("
            " id     INTEGER NOT NULL DEFAULT 0,"
            " type   INTEGER NOT NULL DEFAULT 0,"
            ...
            " PRIMARY KEY(id AUTOINCREMENT)"
            ")");
    DB_EXEC("CREATE TABLE IF NOT EXISTS stock_update_details("
            " id             INTEGER NOT NULL DEFAULT 0,"
